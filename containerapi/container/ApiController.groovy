@Grapes( 
[@Grab(group='org.codehaus.groovy', module='groovy-json', version='2.2.2'),
...
class ApiController {
  ...
  def discoverImages = new DiscoverImages()
  def startContainer = new StartContainer()
...
//TODO, this URL is wrong, refers to an image ID, but is in the container space. bugger.
  @RequestMapping("/container/create/{imageId}")
  @ResponseBody
  def createContainer(@PathVariable String imageId) {
    startContainer(imageId)
  }
