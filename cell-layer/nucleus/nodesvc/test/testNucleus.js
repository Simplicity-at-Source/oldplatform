...
describe('test nucleus: ', function () {
    ...
    it('/container works ok', function (done) {
        var req = request.get(host + '/resource/container');
        req.end(function (res) {
            console.log("/ res: " + res.text);
    ...
    it('create and retrieve record for container', function (done) {

        var h = 'localhost';
        var p = '8080';
        var url = '/resource/container';
        ...
        msh.init(callback, errCallback).put(h, p, url + '/record/sentiment/type/gene', payload).get(h, p, url + '/record/sentiment/type/gene').get(h, p, url).end();
    ...
    it('create pokemon records and query store level with json filter', function (done) {
        ...
        var h = 'localhost';
        var p = '8080';
        var url = '/resource/pokemon/type/muon';
    ...
    it('create records for mutiple substores of foobar service and re-query at service level with json filter', function (done) {
        ...
        var h = 'localhost';
        var p = '8080';
        var svc1Url = '/resource/foobar/type/aa';
        var svc2Url = '/resource/foobar/type/bb';
        ...
        console.log('msh starting...');
        msh.init(callback, errCallback).post(h, p, svc1Url, data1).post(h, p, svc2Url, data2).post(h, p, svc1Url, data3).post(h, p, svc2Url, data4).get(h, p, '/resource/foobar' + q).end();
    ...
    it('create and delete records for testservice', function (done) {
        ...
        var h = 'localhost';
        var p = '8080';
        var url = '/resource/testservice/record/blah/type/default';
